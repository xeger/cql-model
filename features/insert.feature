Feature: INSERT statement
  ...
  Scenario: simple insert
    ...
    Then it should generate CQL: INSERT INTO <model_class> (user_id, tweet_id, name) VALUES (42, 13, 'joe')
  ...
  Examples:
    | ruby                                                                                       | cql                                        |
    | insert(:user_id => 42, :tweet_id => 13, :name => 'joe').timestamp(1366057256324)           | USING TIMESTAMP 1366057256324              |
    | insert(:user_id => 42, :tweet_id => 13, :name => 'joe').ttl(3600)                          | USING TTL 3600                             |
    | insert(:user_id => 42, :tweet_id => 13, :name => 'joe').timestamp(1366057256324).ttl(3600) | USING TIMESTAMP 1366057256324 AND TTL 3600 |
